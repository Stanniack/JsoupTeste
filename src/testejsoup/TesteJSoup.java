    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < TOTAL_WORLDS; i++) {
            ...
            for (int j = FIRST_PAGE; j <= LAST_PAGE; j++) {
                String url = "https://www.tibia.com/community/?subtopic=highscores&world=" + mundos.get(i) + "&list=experience&profession=0&currentpage=" + j;
        ...
        Collections.sort(listaDeChars);
        
        for (int i = 0; i < listaDeChars.size() ; i++) {
            System.out.println((i+1) + " " + listaDeChars.get(i).getName() + " " + listaDeChars.get(i).getLevel() + " " +
                    listaDeChars.get(i).getWorld());
